...
function getSubmissionStatus(assignment: Assignment): {
  ...
  if (assignment.submission.status === 'APPROVED' || assignment.submission.status === 'REJECTED') {
...
export default function AssignmentCard({ assignment, index, onClick }: AssignmentCardProps) {
  ...
  return (
    <div className="rounded-[20px] bg-[#cbeff2] px-6 py-5 text-[#1f3f8f] transition-all hover:shadow-lg">
      {/* Left Content */}
